...
var DarkPinkButton = function DarkPinkButton(_ref) {
  ...
  if (isLoading) {
    return _react.default.createElement("button", {
      ...
      className: "".concat(className, " ").concat(_long ? 'bg-pinkDarkest text-white font-bold py-2 px-10 rounded-px hover:bg-white focus:outline-none  border-2 hover:border-pinkDarkest hover:text-pinkDarkest ${className}' : large ? 'bg-pinkDarkest text-white font-bold py-4 px-8 rounded-px hover:bg-white focus:outline-none  border-2 hover:border-pinkDarkest hover:text-pinkDarkest ${className}' : 'bg-pinkDarkest text-white font-bold py-2 px-8 rounded-px hover:bg-white focus:outline-none  border-2 hover:border-pinkDarkest hover:text-pinkDarkest '),
      onClick: onClick,
      disabled: disabled
...
var _default = DarkPinkButton;
exports.default = _default;

//# sourceMappingURL=DarkPinkButton.js.map